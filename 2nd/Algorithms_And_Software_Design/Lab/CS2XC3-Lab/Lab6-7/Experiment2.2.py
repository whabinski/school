...
while currentSwaps <= totalSwaps:
    ...
    bstData.append(total1/tests)
    rbtData.append(total2/tests)
...
plot.plot([60*i for i in range(11)], bstData, label="BST")
plot.plot([60*i for i in range(11)], rbtData, label="RBT")
